...
//
// for (final PapeSizeSeries page : EnumSet.allOf(PapeSizeSeries.class))
...
// final EnumSet<PapeSizeSeries> set = PapeSizeSeries.getElements(SerieA);
// set.addAll(PapeSizeSeries.getElements(SerieB));
// set.addAll(PapeSizeSeries.getElements(SerieC));
// for (final PapeSizeSeries paper : set)
