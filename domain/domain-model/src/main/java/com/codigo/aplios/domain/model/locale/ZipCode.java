...
@Entity
@Table(name = "ZipCode")
public class ZipCode implements Serializable, IZipCode {
	
	private static final long serialVersionUID = 4072853729370151441L;
	
	//@AttributeOverride(name = "id", column = @Column(name = "id"))
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "zipcode_generator")
	@SequenceGenerator(name = "zipcode_generator", sequenceName = "zipcode_seq", allocationSize = 50)
