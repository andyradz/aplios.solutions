...
import com.codigo.aplios.metric.core.mass.MetricUnitMass;
...
// second.
//kilogram
//[n 2]	kg	M	mass	The kilogram is defined by setting the Planck constant h exactly to 6.62607015×10−34 J⋅s (J = kg⋅m2⋅s−2), given the definitions of the metre and the second.[1]
...
//substance	The amount of substance of exactly 6.02214076×1023 elementary entities.[n 3] This number is the fixed numerical value of the Avogadro constant, NA, when expressed in the unit mol−1 and is called the Avogadro number.
//candela	cd	J	luminous
//intensity	The luminous intensity, in a given direction, of a source that emits monochromatic radiation of frequency 5.4×1014 hertz and that has a radiant intensity in that direction of 
//1
///
//683
// watt per steradian.