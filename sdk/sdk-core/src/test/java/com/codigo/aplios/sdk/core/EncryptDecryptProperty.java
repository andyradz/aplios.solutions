...
public class EncryptDecryptProperty {
     ...
     *        /Key in the properties file that will tell us if the password is already encrypted or
     * not
     *
     * @throws Exception
     */
    public EncryptDecryptProperty(final Path propertyFilePath, final String userPasswordKey,
            final String isPasswordEncryptedKey)
            throws Exception {
    ...
    private String decryptPropertyValue() {
        ...
        final StandardPBEStringEncryptor encryptor = new StandardPBEStringEncryptor();
        encryptor.setPassword("jasypt");
        final String decryptedPropertyValue = encryptor.decrypt(encryptedPropertyValue);
