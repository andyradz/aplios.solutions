...
import com.codigo.aplios.sdk.core.hamcrest.FailsWithMatcher;
import com.codigo.aplios.sdk.core.helpers.StringOperator;
import com.codigo.aplios.sdk.core.value.Valuable;
import com.codigo.aplios.sdk.core.value.ValuableDoubleComparator;
import com.codigo.aplios.sdk.core.value.ValuableIntegerComparator;
import com.codigo.aplios.sdk.core.value.ValuableStringComparator;
...
public class ValuableTest {
	...
	public void test1(final int number) {

		MatcherAssert.assertThat(number % 2, CoreMatchers.is(0));
	}

	@ParameterizedTest
	@ValueSource(strings = { "", "  " })
	public void test2(final String chain) {

		MatcherAssert.assertThat(StringOperator.isNullOrEmpty(chain), CoreMatchers.is(true));
	}

	@ParameterizedTest
	@EnumSource(value = Month.class, names = { "APRIL" }, mode = EnumSource.Mode.MATCH_ALL)
	public void test2(final Month month) {
	...
	public void testInitFromInteger_sholudHasDefaultIntegerValue() {

		final Integer number = Default.of(Integer.class);
		...
		// assert
		MatcherAssert.assertThat(Default.of(Integer.class), CoreMatchers.is(value));
	}
	...
	public void testCompareStringObjectAndStringObject_shouldEqualsResult() {
		...
		// assert
		MatcherAssert.assertThat(true, CoreMatchers.is(CompareOperator.compare(c, propertyOne, propertyTwo)));
	}
