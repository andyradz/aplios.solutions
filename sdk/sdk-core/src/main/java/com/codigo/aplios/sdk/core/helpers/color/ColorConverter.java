...
public final class ColorConverter {
	...
	public static RgbToCmykColorConverter ofRgbToCmyk(final int rgbColorValue) {
		...
		return new RgbToCmykColorConverter(rgbColorValue);
	}

	public static RgbToCmykColorConverter ofRgbToCmyk(final String hexColorValue) {

		return new RgbToCmykColorConverter(hexColorValue);
	}
	...
	public static RgbToHslColorConverter ofRgbToHsl(final int rgbColor) {
		...
		return new RgbToHslColorConverter(rgbColor);
	}

	public static RgbToHslColorConverter ofRgbToHsl(final int rgbRed, final int rgbGreen, final int rgbBlue) {

		return new RgbToHslColorConverter(rgbRed, rgbGreen, rgbBlue);
	}

	/**
	 * Procedura fabrykująca instancję konwertera modelu
	 * kolory<code>RgbToHsvColorConverter</code> na podstawie wartość składowych
	 * modelu RGB
	 *
	 * @param rgbColor Wartość koloru w modelu RGB
	 ...
	 * modelu RGB
	 *
	 * @param rgbRed   Składowa barwy czerwonej modelu RGB
	 * @param rgbGreen Składowa barwy zielonej modelu RGB
	 * @param rgbBlue  Składowa barwy niebieskiej modelu RGB
	 * @return Instancja konwertera koloru RgbToHsvColorConverter
	 */
