 ...
 * <p>
 * With respect to the class {@linkplain org.hamcrest.core.IsSame}, this versions can compare objects of two different
 * classes. So, you can assert as follows:
 * <code>Integer integer = 10; Number number = integer;
 * <p>
 * <p>
 * assertThat(number, sameInstance(integer));</code>
 * <p>
 * <p>
