...
public final class MoneyInWordsModel {
    ...
    public String toString() {
        ...
        myBuilder.append("{");
        myBuilder.append(String.format("sector:10x'%d'", getSector()));
        myBuilder.append(String.format(",units:'%d'", countOfUnit()));
        myBuilder.append(String.format(",teens:'%d'", countOfTeen()));
        myBuilder.append(String.format(",tens:'%d'", countOfTen()));
        myBuilder.append(String.format(",hundreds:'%d'", countOfHundred()));
        myBuilder.append("}");
    ...
    public static class MoneyPartBuilder {
         ...
         * Wyjątek powstaje w przypadku gdy wartości <code>assignValue</code> jest poza zakresem dozwolonych wartości
         * [0-9]
         * </p>
         */
        ...
        /**
         * <p style=
         * 'color:white;background:rgba(1,113,113,0.5);padding:12px;border-radius:2px;border-style: solid;'>
         * Podstawowy konstruktor obiektu klasy.
         * </p>
         *
...
class MoneyInWordsL {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println(MoneyInWordsModel.builder(1)
                .assignUnitCount(5)
                .assignTeenCount(5)
                .assignHundCount(7)
                .assignTenCount(1)
        ...
        for (int idx = 1; idx < 121; idx++) {
            ...
            final Consumer<Integer> inwords = setki.andThen(dziesiatki)
                    .andThen(nastki)
                    .andThen(jednostki);
...
>>>>>>> Wyrówania danych w repozytorium
