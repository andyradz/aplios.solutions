...
public final class ResourceLoader {
	...
	public static void main(final String[] args) throws IOException {
		...
		final ImageBundle img = new ImageBundle();
		for (final String item : img.keySet()) {
			final URL resource = (URL) (new ImageBundle().getObject(item));
		...
		EnvironmentLevel.DEVELOPMENT.getBundle(Bundle.IMAGES);

		final ResourceBundle params = EnvironmentLevel.DEVELOPMENT.getBundle(Bundle.LOG4J);
