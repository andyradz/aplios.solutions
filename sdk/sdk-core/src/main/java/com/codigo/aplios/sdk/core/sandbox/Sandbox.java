package com.codigo.aplios.sdk.core.sandbox;
...
public final class Sandbox {
	...
	public static void main(final String[] args) {
		...
		final Runnable unprivileged = () -> System.getProperty("user.dir");
		...
		System.setSecurityManager(new SecurityManager() {
			...
			public void checkPermission(final Permission perm) {
				...
				for (final Class<?> clasS : this.getClassContext()) {
					...
					{
						final AccessControlContext acc = Sandbox.CHECKED_CLASSES.get(clasS);
						if (acc != null)
					...
					{
						final AccessControlContext acc = Sandbox.CHECKED_CLASS_NAMES.get(clasS.getName());
						if (acc != null)
							acc.checkPermission(perm);
					}
					...
					{
						final AccessControlContext acc = Sandbox.CHECKED_CLASS_LOADERS.get(clasS.getClassLoader());
						if (acc != null)
							acc.checkPermission(perm);
					}
				}
