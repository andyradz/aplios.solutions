...
public class TimeSpec {
	...
	public enum FiscalCalendar {
		...
		FISCALWEEKSPERSHORTMONTH(4), FISCALWEEKSPERLONGMONTH(5), FISCALWEEKSPERLEAPMONTH(6),
		...
		FISCALDAYSPERLEAPYEAR(FISCALDAYSPERYEAR.constant + TimeRelations.DAYSPERWEEK.constant), WEEKSPERSHORTMONTH(4),
		WEEKSPERLONGMONTH(5), WEEKSPERLEAPMONTH(6),
