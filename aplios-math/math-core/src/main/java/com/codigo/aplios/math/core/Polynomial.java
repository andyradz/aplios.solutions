...
// rsnCd = getTagValue ( XPath =
/// 'RequestPayload/Document/DsclInstrStsAdvc/InstrPrcgSts/Accptd/Rsn/RsnCd/Cd',
// tagValueMaxLen = 4 );
// log('Dla $CARef znaleziono $stsMsgTp do $mbr $instrId gdzie rsnCd = $rsnCd a oczekiwano rsnCd =
/// $expectedRsnCd');
// return false;
// endif;
// log('$CARef $stsMsgTp do $mbr $instrId status $expectedSts $expectedRsnCd zgodny z
/// oczekiwaniem');
// endif;
//
//
