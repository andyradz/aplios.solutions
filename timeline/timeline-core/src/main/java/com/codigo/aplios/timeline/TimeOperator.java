...
//			return time;
//		
//		final LocalDateTime day = duration > TimeSpan.ZERO ? LocalDateTime.MAX : LocalDateTime.MIN;
//		
...
//		if (Equals(duration, TimeSpan.Zero))
//			return time;
//		final DateTime day = duration > TimeSpan.Zero ? DateTime.MinValue : DateTime.MaxValue;
//		return new Time(time.ToDateTime(day)
//			.Add(duration));
//	} // operator +
//	
